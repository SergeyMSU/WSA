...
void SphericalHarmonics::computeSphericalHarmonicsWithDerivatives_old(
    int l_max,
    double theta,
    double phi,
...
void SphericalHarmonics::computeSphericalHarmonicsWithDerivatives(
    int l_max,
    double theta,
    double phi,
    std::vector<std::vector<SphericalHarmonicData>>& Y_data) {
...
void SphericalHarmonics::computeMagneticField(
...
std::vector<std::vector<Complex>> SphericalHarmonics::computeSphericalHarmonics_photosphere(
...
double SphericalHarmonics::reconstructBr(
    double theta,
    double phi,
...
void SphericalHarmonics::writeComparisonToFile(
